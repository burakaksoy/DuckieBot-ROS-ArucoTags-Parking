...
class lane_controller(object):
 ...
 ##########################################################
	...
	if (car_control_msg.v == 0.0): #ADDED
            ...
            car_control_msg.omega = (self.k_d * cross_track_err + self.k_theta * heading_err)/1.25 #*self.steer_gain #Right stick H-axis. Right is negative
